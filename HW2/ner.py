...
def _parse_args():
    ...
    parser.add_argument('--crf_model_path', type=str, help='Load crf model from file instead of training')
...
if __name__ == '__main__':
    ...
    if system_to_run == "BAD":
        ...
        if args.crf_model_path:
            with open(args.crf_model_path, 'rb') as f:
